 ...
 */
final class Version20250308083146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT NOT NULL, value INT NOT NULL, discount_type INT NOT NULL, PRIMARY KEY(id))');
