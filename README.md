# Что сделано
* ### Подключен Postgres.
* ### Созданы сущности товара и купона.
* ### В миграцию добавлено создание товаров и купонов необходимых для проверки в requests.http.
* ### Эндпоинты покрыты функциональными тестами.
* ### Купоны имеют формат: буква D или P и целочисленное значение скидки, где P - скидка в процентах от цены, а D - скидка на фиксированное значение. Например, D15 - фиксированная скидка на 15 у.е., P10 - скидка на 10%. 
